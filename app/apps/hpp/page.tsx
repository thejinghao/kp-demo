  ...
  const createHppSession = async () => {
    ...
    try {
      const res = await fetch('/api/klarna/hpp/create-session', {
        ...
        body: JSON.stringify({ session_id: paymentsSession.session_id }),
      });
      const json = await res.json();
